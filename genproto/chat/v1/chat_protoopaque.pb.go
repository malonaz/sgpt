...
type ChatMetadata struct {
	...
	xxx_hidden_Messages     *[]*Message            `protobuf:"bytes,4,rep,name=messages,proto3"`
	xxx_hidden_ModelUsages  *[]*v1.ModelUsage      `protobuf:"bytes,5,rep,name=model_usages,json=modelUsages,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
