...
type ChatConfiguration struct {
	...
	xxx_hidden_Permissions  *[]*PermissionRule     `protobuf:"bytes,7,rep,name=permissions,proto3"`
	xxx_hidden_Agent        *AgentConfiguration    `protobuf:"bytes,8,opt,name=agent,proto3"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
type AgentConfiguration struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_MaxConcurrent int32                  `protobuf:"varint,1,opt,name=max_concurrent,json=maxConcurrent,proto3"`
...
func (x *AgentConfiguration) GetMaxConcurrent() int32 {
	if x != nil {
		return x.xxx_hidden_MaxConcurrent
	}
	return 0
}
...
func (b0 AgentConfiguration_builder) Build() *AgentConfiguration {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_MaxConcurrent = b.MaxConcurrent
