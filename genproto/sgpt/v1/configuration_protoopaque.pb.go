...
type Configuration struct {
	...
	xxx_hidden_ChatService *GRPCClient            `protobuf:"bytes,1,opt,name=chat_service,json=chatService,proto3"`
...
func (x *Configuration) GetChatService() *GRPCClient {
	if x != nil {
		return x.xxx_hidden_ChatService
	}
	return nil
}
...
func (x *Configuration) HasChatService() bool {
	...
	return x.xxx_hidden_ChatService != nil
}
...
func (b0 Configuration_builder) Build() *Configuration {
	...
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_ChatService = b.ChatService
