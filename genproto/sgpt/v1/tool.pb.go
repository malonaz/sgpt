...
func (x *ToolCallMetadata) HasDisplayMessage() bool {
	...
	return x.DisplayMessage != nil
}

func (x *ToolCallMetadata) ClearDisplayMessage() {
	x.DisplayMessage = nil
}
...
type PermissionRule struct {
	...
	Mode          PermissionMode `protobuf:"varint,4,opt,name=mode,proto3,enum=sgpt.v1.PermissionMode" json:"mode,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
