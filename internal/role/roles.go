...
var (
	defaultRoles = []*configuration.Role{
		{
			Name: "code",
			Prompt: `Provide only code as output without any description.
...
Keep your answers as brief and succinct a possible, avoiding any unnecessary words or repetition.`,
		...
		{
			Name: "shell",
			Prompt: `You are SGPT, a programming and {{ os }} system administration assistant.
...
Keep your answers as brief and succinct a possible, avoiding any unnecessary words or repetition.`,
...

		{
			...
			Prompt: `You are a DALL3 Prompt writer. With each response, you *ALWAYS* include a prompt in the following format:
